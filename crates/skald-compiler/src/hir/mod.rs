...
pub use ir::{
    ...
    HirObjectSlice, HirObjectSource, HirObjectView, HirOptionalAssignment, HirOptionalPlace,
    HirOptionalSource, HirOwnerTransfer, HirParameter, HirParameterMode, HirPresenceTestKind,

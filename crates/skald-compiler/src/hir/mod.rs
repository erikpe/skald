...
pub use ir::{
    ...
    HirInterfaceParameter, HirInterfaceReceiver, HirInterfaceRequirement, HirLiteralData,
    ...
    HirOptionalAssignment, HirOptionalOperand, HirOptionalPlace, HirOptionalSharedAssignment,
    HirOptionalSharedInitialize, HirOptionalSharedPlace, HirOptionalSharedSource,
    HirOptionalSource, HirOptionalStorage, HirOptionalWriteKind, HirOwnerTransfer, HirPanic,
    HirParameter, HirParameterMode, HirPresenceTestKind, HirPrimitiveBindingAssignment,
    HirPrimitiveComparison, HirPrimitiveType, HirProgram, HirRequirementImplementation, HirReturn,
    ...
    HirShiftOperation, HirStatement, HirStringLanguageItem, HirStringLiteral, HirSynthesizedCopy,

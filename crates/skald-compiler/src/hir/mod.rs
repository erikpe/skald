...
pub use ir::{
    ...
    HirMethodDispatch, HirMethodKind, HirMethodReceiver, HirObjectCall, HirObjectCallTarget,
    ...
    HirOptionalTypeTable, HirOptionalUnwrapPlan, HirOptionalWriteKind, HirOwnerTransfer, HirPanic,
    HirParameter, HirParameterMode, HirPresenceTestKind, HirPrimitiveAssignment, HirPrimitiveCast,

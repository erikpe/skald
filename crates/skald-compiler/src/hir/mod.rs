...
pub use ir::{
    ...
    HirCallArgument, HirCallStatement, HirCallableSignature, HirCanonicalRangeOrigin,
    HirCheckedIntegerDivision, HirCheckedObjectView, HirCheckedObjectViewKind,
    HirCheckedOptionalView, HirCheckedShift, HirClassDeclaration, HirClassDeclarationTable,
    HirClassDefinition, HirClassDefinitionTable, HirClassOptionalAssignment,
    HirClassOptionalDestinationInitialization, HirClassOptionalInitialize, HirClassOptionalPlace,
    HirClassOptionalSource, HirComparisonOperand, HirComparisonPredicate, HirConditional,
    HirConditionalArm, HirConstruction, HirConstructionMode, HirConstructionOrigin, HirContinue,
    HirControlEffects, HirCopyArgument, HirCopyAssignment, HirCopyAssignmentDeclaration,
    ...
    HirFieldDeclaration, HirFieldPlace, HirFieldWriteAuthorization, HirForIn, HirForInPlan,
    ...
    HirIterationCallTarget, HirIterationItemPlan, HirIterationNextCallPlan, HirIterationProtocol,
    HirIterationReceiver, HirIterationReceiverCarrier, HirIterationReceiverLifetime,
    ...
    HirIterationValueDestruction, HirLiteralData, HirLiteralDataTable, HirLocal, HirLocalDecl,
    ...
    HirPrimitiveRangeIterationPlan, HirPrimitiveStorage, HirPrimitiveType, HirProgram,
    HirProtocolIterationPlan, HirRangeProtocolEvidence, HirRangeProtocolRealization,
    HirRequirementImplementation, HirReturn, HirReturnValue, HirRightShiftFlavor,
    HirScalarAssignment, HirScalarPlace, HirScalarStorage, HirSelectedCopyOperation,
    ...
    HirSignedRemainderSign, HirStatement, HirStaticCopyAssignment, HirStaticFieldDeclaration,

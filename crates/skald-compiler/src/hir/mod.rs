...
pub use ir::{
    ...
    HirFieldPlace, HirFieldWriteAuthorization, HirForIn, HirForInPlan, HirFunctionDeclaration,
    ...
    HirFunctionTypeParameterMode, HirFunctionTypeTable, HirIndexedArrayInitialization,
    ...
    HirInterfaceRequirement, HirIoOperation, HirIterationCallTarget, HirIterationItemPlan,
    ...
    HirPrimitiveRangeEvidence, HirPrimitiveRangeIterationPlan, HirPrimitiveStorage,
    HirPrimitiveType, HirProgram, HirProtocolIterationPlan, HirRangeProtocolEvidence,

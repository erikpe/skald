...
pub use ir::{
    ...
    HirClassDefinitionTable, HirConditional, HirConditionalArm, HirConstruction, HirCopyAssignment,
    HirCopyAssignmentDeclaration, HirCopyCapability, HirCopyConstruction, HirDestructorDeclaration,
    HirExpression, HirExpressionKind, HirFieldAssignment, HirFieldConstruction,
    HirFieldCopyAssignment, HirFieldCopyConstruction, HirFieldDeclaration, HirFieldPlace,

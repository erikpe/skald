...
pub use ir::{
    ...
    HirFieldDeclaration, HirFieldPlace, HirFieldWriteAuthorization, HirForIn,
    ...
    HirPrimitiveStorage, HirPrimitiveType, HirProgram, HirRangeProtocolEvidence,
    HirRangeProtocolRealization, HirRequirementImplementation, HirReturn, HirReturnValue,
    HirRightShiftFlavor, HirScalarAssignment, HirScalarPlace, HirScalarStorage,

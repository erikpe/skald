...
pub use ir::{
    ...
    HirObjectCall, HirObjectCallTarget, HirObjectDestinationInitialization,
    ...
    HirOptionalBoundaryPlans, HirOptionalCheckedAccess, HirOptionalCopyPlan,
    ...
    HirPrimitiveAssignment, HirPrimitiveCast, HirPrimitiveCastKind, HirPrimitiveComparison,
    HirPrimitivePlace, HirPrimitiveStorage, HirPrimitiveType, HirProgram,

...
pub use ir::{
    ...
    HirIntegerBitwiseOperation, HirIntegerCast, HirIntegerDivisionFailure, HirIntegerDivisionKind,
    ...
    HirProgram, HirRequirementImplementation, HirReturn, HirReturnValue, HirRightShiftFlavor,

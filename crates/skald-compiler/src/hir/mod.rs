...
pub use ir::{
    ...
    HirMethodCallTarget, HirMethodDeclaration, HirMethodDispatch, HirMethodReceiver, HirNarrowing,
    HirNarrowingFailure, HirNarrowingKind, HirObjectCall, HirObjectCallTarget,
    HirObjectInitialization, HirObjectOrigin, HirObjectPath, HirObjectPlace, HirObjectProducer,
    HirObjectReturn, HirObjectSlice, HirObjectSource, HirObjectView, HirParameter,

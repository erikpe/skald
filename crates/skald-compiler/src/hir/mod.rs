...
pub use ir::{
    ...
    HirMethodReceiver, HirNarrowing, HirNarrowingFailure, HirNarrowingKind, HirObjectCall,
    ...
    HirViewSource, HirViewTarget, HirVirtualFamily, HirVirtualFamilyTable, ObjectProjection, Type,
};

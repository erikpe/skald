...
pub use ir::{
    ...
    HirArraySource, HirArrayTransfer, HirArrayType, HirArrayTypeTable, HirBaseCopy,
    HirBaseInitialization, HirBinaryOperation, HirBlock, HirBreak, HirCallArgument,
    HirCallStatement, HirCallableSignature, HirCheckedIntegerDivision, HirCheckedObjectView,
    HirCheckedObjectViewKind, HirCheckedOptionalView, HirCheckedShift, HirClassDeclaration,
    ...
    HirMethodDispatch, HirMethodKind, HirMethodReceiver, HirNestedOptionalAssignment,
    ...
    HirObjectView, HirOptionalAliasPlace, HirOptionalArrayUnwrap, HirOptionalAssignment,
    ...
    HirOptionalOperand, HirOptionalPlace, HirOptionalPresenceTestPlan, HirOptionalRepresentation,
    HirOptionalSharedAssignment, HirOptionalSharedInitialize, HirOptionalSharedPlace,
    HirOptionalSharedSource, HirOptionalSource, HirOptionalStorage, HirOptionalStorageCategory,
    HirOptionalType, HirOptionalTypeTable, HirOptionalUnwrapPlan, HirOptionalValue,
    HirOptionalValuePlace, HirOptionalValueSource, HirOptionalWriteKind, HirOwnerTransfer,
    HirPanic, HirParameter, HirParameterMode, HirPresenceTestKind, HirPrimitiveAssignment,
    ...
    HirReturnValue, HirRightShiftFlavor, HirSelectedCopyOperation, HirSharedAllocation,
    ...
    HirSharedSource, HirSharedTarget, HirSharedTransfer, HirShiftDirection, HirShiftFailure,
    HirShiftOperation, HirSignedIntegerDivisionSemantics, HirSignedMinimumPairResult,
    HirSignedQuotientRounding, HirSignedRemainderSign, HirStatement, HirStaticFieldDeclaration,
    HirStaticFieldInitializer, HirStaticPlace, HirStoredValueInitialization, HirStringLanguageItem,

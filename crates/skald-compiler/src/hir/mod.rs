...
pub use ir::{
    ...
    HirObjectSlice, HirObjectSource, HirObjectView, HirOptionalAliasPlace, HirOptionalArrayUnwrap,
    ...
    HirOptionalBoxPointee, HirOptionalBoxType, HirOptionalBoxTypeTable, HirOptionalCheckedAccess,

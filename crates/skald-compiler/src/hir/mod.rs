...
pub use ir::{
    ...
    HirMethodDeclaration, HirMethodDispatch, HirObjectCall, HirObjectCallTarget,
    ...
    HirReturn, HirReturnValue, HirSelectedCopyOperation, HirStatement, HirSynthesizedCopy,

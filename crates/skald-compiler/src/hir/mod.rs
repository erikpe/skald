...
pub use ir::{
    ...
    HirReturnValue, HirSelectedCopyOperation, HirSharedAllocation, HirSharedAllocationMode,
    ...
    HirSharedTransfer, HirStatement, HirStringLanguageItem, HirStringLiteral, HirSynthesizedCopy,

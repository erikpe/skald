...
pub use ir::{
    ...
    HirLocalDecl, HirLocalInitializer, HirMemberDefinition, HirMethodCallTarget,
    HirMethodDeclaration, HirMethodDispatch, HirMethodKind, HirMethodReceiver, HirObjectCall,
    ...
    HirOwnerTransfer, HirParameter, HirParameterMode, HirPresenceTestKind, HirPrimitiveType,

...
pub use ir::{
    ...
    HirClassDefinitionTable, HirConditional, HirConditionalArm, HirConstruction, HirCopyArgument,
    HirCopyAssignment, HirCopyAssignmentDeclaration, HirCopyCapability, HirCopyConstruction,
    HirDestructionPlan, HirDestructionStep, HirDestructorDeclaration, HirDirectBase, HirExpression,
    HirExpressionKind, HirFieldAssignment, HirFieldConstruction, HirFieldCopyAssignment,
    HirFieldCopyConstruction, HirFieldDeclaration, HirFieldPlace, HirFunctionDeclaration,
    HirFunctionDeclarationTable, HirFunctionDefinition, HirFunctionDefinitionTable,
    HirFunctionLinkage, HirInitializerDeclaration, HirInterfaceCallTarget, HirInterfaceConformance,
    ...
    HirObjectSlice, HirObjectSource, HirObjectView, HirParameter, HirParameterMode, HirProgram,
    HirRequirementImplementation, HirReturn, HirReturnValue, HirSelectedCopyOperation,
    HirStatement, HirSynthesizedCopy, HirSynthesizedFieldCopy, HirTypeTest, HirTypeTestKind,

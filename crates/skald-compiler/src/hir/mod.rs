...
pub use ir::{
    ...
    HirClassDefinitionTable, HirClassOptionalAssignment, HirClassOptionalInitialize,
    HirClassOptionalPlace, HirClassOptionalSource, HirConditional, HirConditionalArm,
    ...
    HirOptionalStorage, HirOptionalWriteKind, HirOwnerTransfer, HirParameter, HirParameterMode,
    HirPresenceTestKind, HirPrimitiveType, HirProgram, HirRequirementImplementation, HirReturn,

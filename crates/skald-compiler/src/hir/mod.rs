...
pub use ir::{
    ...
    HirInterfaceReceiver, HirInterfaceRequirement, HirIoOperation, HirLiteralData,
    HirLiteralDataTable, HirLocal, HirLocalDecl, HirLocalInitializer, HirLogicalExpression,
    HirLogicalOperation, HirMemberDefinition, HirMethodCallTarget, HirMethodDeclaration,
    HirMethodDispatch, HirMethodKind, HirMethodReceiver, HirNestedOptionalUnwrap, HirObjectCall,
    HirObjectCallTarget, HirObjectDestinationInitialization, HirObjectInitialization,
    HirObjectOrigin, HirObjectPath, HirObjectPlace, HirObjectProducer, HirObjectReceiver,
    HirObjectReturn, HirObjectSlice, HirObjectSource, HirObjectView, HirOptionalAliasPlace,
    HirOptionalArrayUnwrap, HirOptionalAssignment, HirOptionalAssignmentPlan,
    HirOptionalBoundaryPlan, HirOptionalBoundaryPlans, HirOptionalBoxAllocation,
    HirOptionalBoxEvaluationOrder, HirOptionalBoxObjectView, HirOptionalBoxPointee,
    HirOptionalBoxPresence, HirOptionalBoxType, HirOptionalBoxTypeTable, HirOptionalCheckedAccess,
    HirOptionalCopyPlan, HirOptionalDestructionPlan, HirOptionalInitializationPlan,
    HirOptionalInjectionPlan, HirOptionalLifecycle, HirOptionalOperand, HirOptionalPlace,
    HirOptionalPresenceTestPlan, HirOptionalRepresentation, HirOptionalSharedAssignment,
    HirOptionalSharedInitialize, HirOptionalSharedPlace, HirOptionalSharedSource,
    HirOptionalSource, HirOptionalStorage, HirOptionalStorageCategory, HirOptionalType,
    HirOptionalTypeTable, HirOptionalUnwrapPlan, HirOptionalValue, HirOptionalValuePlace,
    HirOptionalValueSource, HirOptionalWriteKind, HirOwnerTransfer, HirPanic, HirParameter,
    HirParameterMode, HirPresenceTestKind, HirPrimitiveAssignment, HirPrimitiveCast,
    HirPrimitiveCastKind, HirPrimitiveComparison, HirPrimitivePlace, HirPrimitiveStorage,
    HirPrimitiveType, HirProgram, HirRequirementImplementation, HirReturn, HirReturnValue,
    HirRightShiftFlavor, HirSelectedCopyOperation, HirSharedAllocation, HirSharedAllocationMode,
    HirSharedAssignment, HirSharedCast, HirSharedCastKind, HirSharedFieldWrite,
    HirSharedFieldWriteKind, HirSharedPlace, HirSharedProducer, HirSharedSource,
    HirSharedStaticAssignment, HirSharedTarget, HirSharedTransfer, HirShiftDirection,

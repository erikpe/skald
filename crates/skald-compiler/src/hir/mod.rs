...
pub use ir::{
    ...
    HirObjectView, HirOptionalAliasPlace, HirOptionalAssignment, HirOptionalAssignmentPlan,
    HirOptionalBoundaryPlan, HirOptionalBoundaryPlans, HirOptionalCheckedAccess,

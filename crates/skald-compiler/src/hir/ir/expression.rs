...
use super::{
    ...
    HirOptionalOperand, HirOptionalSource, HirPresenceTestKind, HirSharedPlace, HirSharedTransfer,
    Type,
};
...
impl HirCallArgument {
    pub const fn span(&self) -> Span {
        match self {
            ...
            Self::AggregateOptional(value) => value.span,
            Self::OptionalPlace(place) => place.span(),
            Self::OptionalSharedPlace(place) => place.span,

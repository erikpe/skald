...
pub use expression::{
    ...
    HirCopyArgument, HirExpression, HirExpressionKind, HirFunctionReference, HirIndirectCall,
...
pub use iteration::{
    HirForIn, HirForInPlan, HirIterationCallTarget, HirIterationItemPlan, HirIterationNextCallPlan,
    ...
    HirPrimitiveRangeEvidence, HirPrimitiveRangeIterationPlan, HirProtocolIterationPlan,
    HirRangeProtocolEvidence, HirRangeProtocolRealization,
};
pub use object::{
    ...
    HirObjectSource, HirObjectView, HirSelectedCopyOperation, HirStaticCopyAssignment,
...
pub use optional::{
    ...
    HirOptionalBoxObjectView, HirOptionalBoxPointee, HirOptionalBoxPresence, HirOptionalOperand,

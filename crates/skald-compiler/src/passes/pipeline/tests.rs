...
";
const ALL_PRODUCTION_PASS_NAMES: [&str; 13] = [
...
fn productive_default_profile_has_exact_reference_parity_and_structural_value() {
    ...
    assert_eq!(measured.statistics.pass_executions(), 17);
    assert!(
        measurement_total(
            &measured,
            "primitive-constant-folding",
...
fn production_boundary_selection_matrix_is_normalized_and_compositional() {
    ...
    assert_eq!(default.statistics.pass_executions(), 17);
    ...
    assert_eq!(
        ...
        [
            ...
            529_661_416_656_553_642,
            529_661_416_656_553_642,
            17_120_109_253_232_500_399,
            12_593_903_038_934_416_155,
            12_593_903_038_934_416_155,
            12_806_308_209_682_325_425,
            8_151_533_879_899_296_625,
            8_151_533_879_899_296_625,
        ]
    );
    assert_eq!(
...
fn checkpoint_api_identifies_every_stage_and_occurrence() {
    ...
    assert_eq!(
        ...
        [
            ...
            "after-proof-rich-4-integer-cast-chain-canonicalization-0",
            "after-proof-rich-5-checked-integer-constant-folding-0",
            "after-proof-rich-6-checked-f64-to-integer-constant-folding-0",
            "after-proof-rich-7-primitive-constant-folding-2",
            "after-proof-rich-8-dead-pure-definition-elimination-1",
            "after-proof-rich-9-conservative-cfg-cleanup-0",
            "after-proof-rich-10-dead-pure-definition-elimination-2",
            "after-proof-transition-11-constant-short-circuit-folding-0",
            "after-proof-normalization",
            "after-final-12-post-proof-unreachable-block-elimination-0",
            "after-final-13-dead-normalized-path-activation-cleanup-0",
            "after-final-14-post-proof-empty-block-forwarding-0",
            "after-final-15-post-proof-basic-block-merging-0",
            "after-final-16-whole-world-reachability-0",
            "final",
        ]
    );
    assert_eq!(

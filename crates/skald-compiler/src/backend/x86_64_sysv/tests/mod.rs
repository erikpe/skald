...
use crate::{
    ...
    mir::{
        ...
        MirClassDeclarationTable, MirCleanup, MirDestructionPlan, MirFieldDeclaration,
        ...
        MirParameter, MirParameterMode, MirPlace, MirProgram, MirReceiverAccess, MirRvalue,

...
use crate::{
    ...
    mir::{
        ...
        MirMethodCallTarget, MirMethodDeclaration, MirMethodKind, MirMethodReceiver,
        MirObjectOrigin, MirParameter, MirParameterMode, MirPlace, MirPrimitiveComparison,
        MirProgram, MirReceiverAccess, MirRvalue, MirRvalueKind, MirSelectedCopyOperation,
        MirSharedCopy, MirSharedRelease, MirSharedTarget, MirStorage, MirStorageKind,
        MirTerminationReason, MirTerminator, MirType, MirUnaryOperation, MirValue, MirViewTarget,

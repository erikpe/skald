...
fn disabled_pass_names_are_validated_once_in_deterministic_order() {
    ...
    let expected = "unknown MIR pass names: `missing-pass`, `zeta-pass`; known MIR passes: `checked-f64-to-integer-constant-folding`, `checked-integer-constant-folding`, `conservative-cfg-cleanup`, `constant-short-circuit-folding`, `dead-pure-definition-elimination`, `integer-cast-chain-canonicalization`, `post-proof-basic-block-merging`, `post-proof-empty-block-forwarding`, `post-proof-unreachable-block-elimination`, `primitive-algebraic-simplification`, `primitive-constant-folding`, `whole-world-reachability`";

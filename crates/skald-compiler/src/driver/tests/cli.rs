...
fn mir_optimization_cli_selection_is_typed_and_precedes_source_io() {
    ...
    let cases = [
        (
            ...
            "unknown MIR pass name: `unknown-pass`; known MIR passes: `checked-f64-to-integer-constant-folding`, `checked-integer-constant-folding`, `conservative-cfg-cleanup`, `constant-short-circuit-folding`, `dead-pure-definition-elimination`, `integer-cast-chain-canonicalization`, `post-proof-basic-block-merging`, `post-proof-empty-block-forwarding`, `post-proof-unreachable-block-elimination`, `primitive-algebraic-simplification`, `primitive-constant-folding`, `whole-world-reachability`",
        ),
        (
            vec![
                "skac",

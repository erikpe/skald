...
use crate::identity::{
    ...
    InterfaceTemplateId, LiteralDataId, ModuleId, OptionalBoxTypeId, OptionalTypeId,
    VirtualFamilyId,
};
...
impl DenseId for ExternalLinkId {
    fn index(self) -> usize {
        self.index()
    }
}
...
impl DenseId for ClassTemplateId {
    fn index(self) -> usize {
        self.index()
    }
}
impl DenseId for InterfaceTemplateId {
    fn index(self) -> usize {
        self.index()
    }
}
impl DenseId for InterfaceId {
    fn index(self) -> usize {
        self.index()
    }
}

impl DenseId for ArrayTypeId {
    fn index(self) -> usize {
        self.index()
    }
}

impl DenseId for OptionalTypeId {
    fn index(self) -> usize {
        self.index()
    }
}

impl DenseId for OptionalBoxTypeId {
    fn index(self) -> usize {
        self.index()
    }
}

impl DenseId for LiteralDataId {
    fn index(self) -> usize {
        self.index()
    }
}

...
impl<'ast> ProgramResolver<'ast> {
    ...
    fn resolve_collected_declarations(mut self, collected: CollectedDeclarations) -> ResolveOutput {
        ...
        let program = CandidateProgram::new(CandidateProgramProducts {
            retained: RetainedProgramProducts {
                modules: self.modules,
                external_links,
                module_bindings,
                ordinary_bindings,
            ...
            classes: ClassPublicationProducts {
                specializations: generic_specializations,
                declarations: class_declarations,
                hierarchy,
            },
            interfaces: InterfacePublicationProducts {
                specializations: generic_interface_specializations,
                declarations: interfaces,
            },
            executable: ExecutablePublicationProducts {
                functions: resolved_bodies.functions,
                virtual_families,
                classes: resolved_bodies.classes,
            },
        })

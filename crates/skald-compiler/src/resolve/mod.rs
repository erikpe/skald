...
pub use ir::{
    ...
    ResolvedInterfaceTemplateTypeUseContext, ResolvedLiteralData, ResolvedLiteralDataTable,
    ResolvedLocal, ResolvedLocalDecl, ResolvedLogicalExpr, ResolvedLogicalOperator,
    ...
    ResolvedObjectTarget, ResolvedOptionalAssignment, ResolvedOptionalBoxAllocationExpr,
    ResolvedOptionalBoxInitializer, ResolvedOptionalBoxType, ResolvedOptionalBoxTypeTable,
    ResolvedOptionalType, ResolvedOptionalTypeTable, ResolvedOrdinaryBinding,
    ...
    ResolvedPrimitiveCastExpr, ResolvedPrimitiveType, ResolvedProgram, ResolvedReceiverAccess,
...
pub use resolver::{
    ...
    INVALID_GENERIC_BOUND, INVALID_GENERIC_INTERFACE_REQUIREMENT, INVALID_INDEX_PROTOCOL,
    INVALID_INTERFACE_CLAIM, INVALID_INTRINSIC_DECLARATION, INVALID_LIFECYCLE_SIGNATURE,

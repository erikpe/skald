...
pub use ir::{
    ...
    ResolvedOptionalAssignment, ResolvedOptionalBoxAllocationExpr, ResolvedOptionalBoxInitializer,
    ResolvedOptionalBoxType, ResolvedOptionalBoxTypeTable, ResolvedOptionalType,
    ResolvedOptionalTypeTable, ResolvedOrdinaryBinding, ResolvedOrdinaryBindingTable,
    ResolvedOrdinaryBindings, ResolvedParameter, ResolvedParameterBindingMode,
    ResolvedPresenceTestExpr, ResolvedPresenceTestKind, ResolvedPrimitiveCastExpr,
...
pub use resolver::{
    ...
    INVALID_OPERATOR_LANGUAGE_ITEM, INVALID_OPTIONAL_TYPE, INVALID_OVERRIDE,
    INVALID_POINTEE_ASSIGNMENT, INVALID_STRING_LANGUAGE_ITEM, ITERATION_ITEM_TYPE_MISMATCH,
    LOOP_EXIT_OUTSIDE_LOOP, MISSING_ITERABLE_APPLICATION, MISSING_STRING_LANGUAGE_ITEM,

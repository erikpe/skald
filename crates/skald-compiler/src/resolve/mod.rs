...
pub use ir::{
    ...
    ResolvedByteLiteralExpr, ResolvedCanonicalRangeOrigin, ResolvedClassDeclaration,
    ResolvedClassDeclarationTable, ResolvedClassDefinition, ResolvedClassDefinitionTable,
    ResolvedClassHierarchy, ResolvedClassMember, ResolvedClassTemplate, ResolvedClassTemplateTable,
    ResolvedConditional, ResolvedConditionalArm, ResolvedConstructExpr, ResolvedConstructionMode,
    ResolvedConstructionOrigin, ResolvedContinue, ResolvedCopyAssignmentDeclaration,

...
pub use ir::{
    ...
    ResolvedInitializerDeclaration, ResolvedIntegerCastExpr, ResolvedIntegerType,
    ...
    ResolvedLocalDecl, ResolvedMemberDefinition, ResolvedMemberVisibility, ResolvedMethodCallExpr,
    ...
    ResolvedObjectCastTargetMode, ResolvedObjectPlace, ResolvedObjectReceiver,
    ResolvedOptionalAssignment, ResolvedOptionalPayload, ResolvedOrdinaryBinding,
    ...
    ResolvedPrimitiveLocalAssignment, ResolvedProgram, ResolvedReceiverAccess, ResolvedReturn,
...
pub use resolver::{
    ...
    INVALID_LIFECYCLE_SIGNATURE, INVALID_LOCAL_ASSIGNMENT, INVALID_MEMBER_SELECTION,
    INVALID_OPTIONAL_TYPE, INVALID_OVERRIDE, INVALID_POINTEE_ASSIGNMENT,
    INVALID_STRING_LANGUAGE_ITEM, MISSING_STRING_LANGUAGE_ITEM, MODULE_CONTEXT_REQUIRED,
    PRIVATE_DECLARATION, PRIVATE_MEMBER_ACCESS, SELF_OUTSIDE_MEMBER, TOP_LEVEL_USED_AS_VALUE,
    UNKNOWN_IMPORTED_DECLARATION, UNKNOWN_MEMBER, UNKNOWN_MODULE_BINDING, UNKNOWN_NAME,
    UNKNOWN_QUALIFIED_DECLARATION, UNKNOWN_TYPE,
};

...
pub use ir::{
    ...
    ResolvedConditionalArm, ResolvedConstructExpr, ResolvedConstructionMode,
    ...
    ResolvedOptionalPayload, ResolvedParameter, ResolvedParameterBindingMode,
    ...
    ResolvedUnwrapExpr, ResolvedVirtualFamily, ResolvedVirtualFamilyTable,
};
pub use resolver::{

...
pub use resolver::{
    ...
    INVALID_POINTEE_ASSIGNMENT, MISSING_STRING_LANGUAGE_ITEM, MODULE_CONTEXT_REQUIRED,
    PRIVATE_DECLARATION, PRIVATE_MEMBER_ACCESS, SELF_OUTSIDE_MEMBER, STRING_LITERAL_NOT_TYPED,

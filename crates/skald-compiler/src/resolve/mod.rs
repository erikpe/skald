...
pub use ir::{
    ...
    ResolvedFunctionTypeTable, ResolvedGroupedExpr, ResolvedInitializerDeclaration,
    ...
    ResolvedInterfaceRequirement, ResolvedLiteralData, ResolvedLiteralDataTable, ResolvedLocal,
...
pub use resolver::{
    ...
    INDIRECT_FUNCTION_CALL_NOT_YET_SUPPORTED, INHERITANCE_CYCLE, INHERITED_MEMBER_COLLISION,

...
pub use ir::{
    ...
    ResolvedIndirectCallExpr, ResolvedInitializerDeclaration, ResolvedInterfaceCallExpr,
    ResolvedInterfaceClaim, ResolvedInterfaceDeclaration, ResolvedInterfaceDeclarationTable,
    ResolvedInterfaceParameter, ResolvedInterfaceReceiver, ResolvedInterfaceRequirement,
    ResolvedInterfaceTemplate, ResolvedInterfaceTemplateBound, ResolvedInterfaceTemplateParameter,

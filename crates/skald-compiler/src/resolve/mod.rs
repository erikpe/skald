...
pub use ir::{
    ...
    ResolvedClassMember, ResolvedClassTemplate, ResolvedClassTemplateTable, ResolvedConditional,
    ResolvedConditionalArm, ResolvedConstructExpr, ResolvedConstructionMode, ResolvedContinue,
    ...
    ResolvedForInSource, ResolvedFunctionDeclaration, ResolvedFunctionDeclarationTable,
    ResolvedFunctionDefinition, ResolvedFunctionDefinitionTable, ResolvedFunctionLinkage,
    ResolvedFunctionReferenceExpr, ResolvedFunctionType, ResolvedFunctionTypeParameter,
    ResolvedFunctionTypeParameterMode, ResolvedFunctionTypeTable, ResolvedGroupedExpr,
    ResolvedIndexedArrayInitializer, ResolvedIndirectCallExpr, ResolvedInitializerDeclaration,
    ResolvedInterfaceCallExpr, ResolvedInterfaceClaim, ResolvedInterfaceDeclaration,
    ResolvedInterfaceDeclarationTable, ResolvedInterfaceParameter, ResolvedInterfaceReceiver,
    ResolvedInterfaceRequirement, ResolvedInterfaceTemplate, ResolvedInterfaceTemplateBound,
    ...
    ResolvedInterfaceType, ResolvedIterableLanguageItem, ResolvedIterableSelection,
    ResolvedLiteralData, ResolvedLiteralDataTable, ResolvedLocal, ResolvedLocalDecl,
    ResolvedLogicalExpr, ResolvedLogicalOperator, ResolvedMemberDefinition,
    ...
    ResolvedObjectPlace, ResolvedObjectReceiver, ResolvedObjectTarget,
    ResolvedOperatorLanguageItem, ResolvedOperatorProtocol, ResolvedOperatorProtocolParameters,
    ResolvedOperatorResolution, ResolvedOperatorSelection, ResolvedOptionalAssignment,
    ...
    ResolvedRangeEndpointProvenance, ResolvedRangeForSource, ResolvedRangeLanguageItem,
    ResolvedRangeProtocolEvidence, ResolvedRangeProtocolRealization, ResolvedReceiverAccess,
    ResolvedReturn, ResolvedScalarBindingAssignment, ResolvedSharedAssignment,
    ResolvedSharedTarget, ResolvedSharedTargetCategory, ResolvedStatement, ResolvedStaticCallExpr,
...
pub use resolver::{
    ...
    DUPLICATE_GENERIC_BOUND, DUPLICATE_MEMBER, DUPLICATE_MODULE_BINDING,
    ...
    INCOMPATIBLE_GENERIC_OPERATOR_RHS, INHERITANCE_CYCLE, INHERITED_MEMBER_COLLISION,
    INVALID_BASE_CLASS, INVALID_BASE_INITIALIZATION, INVALID_CALL_TARGET,
    INVALID_CONSTRUCTION_TARGET, INVALID_DEREFERENCE, INVALID_FUNCTION_REFERENCE,
    INVALID_GENERIC_APPLICATION, INVALID_GENERIC_BASE, INVALID_GENERIC_BOUND,
    INVALID_GENERIC_INTERFACE_REQUIREMENT, INVALID_INDEX_PROTOCOL, INVALID_INTERFACE_CLAIM,
    INVALID_INTRINSIC_DECLARATION, INVALID_ITERABLE_LANGUAGE_ITEM, INVALID_LIFECYCLE_SIGNATURE,
    INVALID_MEMBER_SELECTION, INVALID_OPERATOR_LANGUAGE_ITEM, INVALID_OPTIONAL_TYPE,
    INVALID_OVERRIDE, INVALID_POINTEE_ASSIGNMENT, INVALID_RANGE_LANGUAGE_ITEM,

...
pub use ir::{
    ...
    ResolvedConditionalArm, ResolvedConstructExpr, ResolvedCopyAssignmentDeclaration,
    ResolvedCopyOperation, ResolvedDestructorDeclaration, ResolvedDirectCallExpr,
    ResolvedExpression, ResolvedExpressionStatement, ResolvedFieldAccessExpr,
    ResolvedFieldAssignment, ResolvedFieldDeclaration, ResolvedFunctionDeclaration,

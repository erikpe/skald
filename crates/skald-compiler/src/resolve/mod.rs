...
pub use ir::{
    ...
    ResolvedSharedTarget, ResolvedStatement, ResolvedStaticCallExpr, ResolvedStringLanguageItem,
    ResolvedStringLiteralExpr, ResolvedTopLevelId, ResolvedType, ResolvedTypeKind,
...
pub use resolver::{
    ...
    INVALID_POINTEE_ASSIGNMENT, INVALID_STRING_LANGUAGE_ITEM, MISSING_STRING_LANGUAGE_ITEM,

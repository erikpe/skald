...
pub use ir::{
    ...
    ResolvedLiteralDataTable, ResolvedLocal, ResolvedLocalDecl, ResolvedMemberDefinition,
    ...
    ResolvedStaticCallExpr, ResolvedStringLanguageItem, ResolvedStringLiteralExpr,

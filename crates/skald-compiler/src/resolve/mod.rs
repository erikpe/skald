...
pub use ir::{
    ...
    ResolvedObjectReceiver, ResolvedOptionalAssignment, ResolvedOptionalType,
    ...
    ResolvedStaticCallExpr, ResolvedStaticFieldAccessExpr, ResolvedStaticFieldAssignment,
    ResolvedStaticFieldDeclaration, ResolvedStaticFieldInitializer, ResolvedStringLanguageItem,

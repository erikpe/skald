...
fn resolved_alias_dump_is_exact_and_identity_based() {
    ...
    assert_eq!(
        ...
        concat!(
            ...
            "  ModuleDeclarations\n",
            "    Module m0\n",
            "      private f0 \"inspect\" @3..10\n",
            "      private c0 \"Dog\" @86..89\n",
            "      private f1 \"main\" @132..136\n",
            "  Entry f1\n",
            "  ClassDeclarations\n",
            "    Class c0 module m0 \"Dog\" @80..128\n",
            "      Fields\n",
            ...
            "      Methods\n",
            "  Declarations\n",
            "    Declaration f0 module m0 \"inspect\" internal @0..79\n",
            "      Parameters\n",
            ...
            "      ReturnType\n",
            "        Type Unit @49..53\n",
            "    Declaration f1 module m0 \"main\" internal @129..159\n",
            "      Parameters\n",
            "      ReturnType\n",
            "        Type I64 @142..145\n",
            "  Definitions\n",

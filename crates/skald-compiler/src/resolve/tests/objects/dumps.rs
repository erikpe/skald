...
fn resolved_direct_base_dump_is_exact_and_identity_based() {
    ...
    assert_eq!(
        ...
        concat!(
            ...
            "  ModuleDeclarations\n",
            "    Module m0\n",
            "      private c0 \"Derived\" @6..13\n",
            "      private c1 \"Base\" @36..40\n",
            "  Entry <none>\n",
            "  ClassDeclarations\n",
            "    Class c0 module m0 \"Derived\" @0..29\n",
            "      DirectBase c1 @22..26\n",
            "      Fields\n",
            "      OrdinaryInitializers\n",
            "      CopyConstructor\n",
...
fn resolved_destructor_dump_is_exact_and_identity_based() {
    ...
    assert_eq!(
        ...
        concat!(
            ...
            "  ModuleDeclarations\n",
            "    Module m0\n",
            "      private c0 \"Empty\" @6..11\n",
            "      private f0 \"main\" @49..53\n",
            "  Entry f0\n",
            "  ClassDeclarations\n",
            "    Class c0 module m0 \"Empty\" @0..45\n",
            "      Fields\n",
            "      OrdinaryInitializers\n",
            ...
            "      Methods\n",
            "  Declarations\n",
            "    Declaration f0 module m0 \"main\" internal @46..76\n",
            "      Parameters\n",
            "      ReturnType\n",
            "        Type I64 @59..62\n",
            "  Definitions\n",
...
fn resolved_object_dump_is_exact_and_identity_based() {
    ...
    assert_eq!(
        ...
        concat!(
            ...
            "            Type I64 @77..80\n",
            "  Declarations\n",
            "    Declaration f0 module m0 \"main\" internal @106..167\n",
            "      Parameters\n",
            "      ReturnType\n",
            "        Type I64 @119..122\n",
            "  Definitions\n",

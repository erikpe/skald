...
pub use body::{
    ...
    ResolvedForIn, ResolvedForInSource, ResolvedFunctionDefinition,
    ResolvedFunctionDefinitionTable, ResolvedIterableSelection, ResolvedLocalDecl,
    ResolvedMemberDefinition, ResolvedObjectAssignment, ResolvedOptionalAssignment,
    ResolvedRangeEndpointProvenance, ResolvedRangeForSource, ResolvedRangeProtocolEvidence,
    ResolvedRangeProtocolRealization, ResolvedReturn, ResolvedScalarBindingAssignment,
    ResolvedSharedAssignment, ResolvedStatement, ResolvedStaticFieldAssignment, ResolvedWhile,
};
...
pub use expression::{
    ...
    ResolvedIndexedArrayInitializer, ResolvedIndirectCallExpr, ResolvedInterfaceCallExpr,
    ...
    ResolvedObjectCastTargetMode, ResolvedOptionalBoxAllocationExpr,

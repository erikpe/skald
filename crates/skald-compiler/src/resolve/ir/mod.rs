...
pub use expression::{
    ...
    ResolvedBindingExpr, ResolvedBooleanExpr, ResolvedByteLiteralExpr,
    ResolvedCanonicalRangeOrigin, ResolvedConstructExpr, ResolvedConstructionMode,
    ResolvedConstructionOrigin, ResolvedDereferenceExpr, ResolvedDereferenceOperator,
    ...
    ResolvedPrimitiveType, ResolvedRangeProtocolEvidence, ResolvedRangeProtocolRealization,

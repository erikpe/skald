...
pub use model::{
    ...
    MirStaticAllocationOrigin, MirStaticDataMutability, MirStaticFieldInitialization,
    ...
    MirVirtualFamily, MirVirtualFamilyTable, OptionalGuardId, PathConditionId, PlannedMirProgram,

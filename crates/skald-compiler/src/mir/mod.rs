...
pub use model::{
    ...
    MirInitializerDeclaration, MirInstruction, MirIntegerCast, MirIntegerType,
    ...
    MirPrimitiveType, MirProgram, MirReceiverAccess, MirRequirementImplementation, MirRvalue,
    MirRvalueKind, MirSelectedCopyOperation, MirSharedAdopt, MirSharedAllocate,

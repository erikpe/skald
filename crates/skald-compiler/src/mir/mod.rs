...
pub use model::{
    ...
    MirObjectOrigin, MirObjectView, MirOptionalAssign, MirOptionalInitialize,
    ...
    MirOptionalViewEnd, MirParameter, MirParameterMode, MirPlace, MirPlaceBase, MirPlaceProjection,
    MirPresenceTestKind, MirPrimitiveType, MirProgram, MirReceiverAccess,
    MirRequirementImplementation, MirRvalue, MirRvalueKind, MirSelectedCopyOperation,
    ...
    MirSharedPublish, MirSharedRelease, MirSharedTarget, MirStorage, MirStorageKind, MirStore,
    ...
    MirVirtualFamilyTable, OptionalGuardId, StorageId, ValueId,
};

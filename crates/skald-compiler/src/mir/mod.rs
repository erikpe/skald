...
pub use model::{
    ...
    MirMethodReceiver, MirNarrowedAliasBinding, MirNarrowedAliasEnd, MirObjectOrigin,
    MirObjectView, MirParameter, MirParameterMode, MirPlace, MirPlaceBase, MirPlaceProjection,
    MirProgram, MirReceiverAccess, MirRequirementImplementation, MirRvalue, MirRvalueKind,

...
pub use model::{
    ...
    MirFunctionDefinitionTable, MirFunctionLinkage, MirFunctionType, MirFunctionTypeTable,
    MirIndirectCallTarget, MirInitialize, MirInitializerDeclaration, MirInstruction,

...
pub use model::{
    ...
    MirPresenceTestKind, MirPrimitiveCast, MirPrimitiveCastKind, MirPrimitiveCastRangeCheck,
    MirPrimitiveComparison, MirPrimitiveType, MirProgram, MirReceiverAccess,

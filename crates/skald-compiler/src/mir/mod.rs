...
pub use model::{
    ...
    MirArrayInstruction, MirArrayLifecycle, MirArrayLifecycleOperation, MirArrayLoopKind,
    MirArrayOwnership, MirArrayPositionKind, MirArrayType, MirArrayTypeTable, MirAssignment,
    MirBaseCopy, MirBasicBlock, MirBinaryOperation, MirBody, MirCall, MirCallReceiver,
    MirCallTarget, MirCallableAddress, MirCallableSignature, MirCellWriteAuthorization,
    MirCheckedViewBinding, MirCheckedViewEnd, MirClassDeclaration, MirClassDeclarationTable,
    MirClassLifecycleOperation, MirClassOptionalAssign, MirClassOptionalCleanup,
    ...
    MirEndFullExpression, MirExecutionNode, MirF64ToIntegerRange, MirF64ToIntegerRounding,
    MirFieldDeclaration, MirFinalWriteAuthorization, MirFunctionDeclaration,

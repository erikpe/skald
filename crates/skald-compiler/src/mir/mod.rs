...
pub use model::{
    ...
    MirCall, MirCallReceiver, MirCallTarget, MirCallableSignature, MirCheckedViewBinding,
    MirCheckedViewEnd, MirClassDeclaration, MirClassDeclarationTable, MirClassOptionalAssign,
    MirClassOptionalCleanup, MirClassOptionalInitialize, MirClassOptionalPublish,
    MirClassOptionalSource, MirCleanup, MirComparisonOperand, MirComparisonPredicate,
    ...
    MirDestructorDeclaration, MirDirectBase, MirEndFullExpression, MirF64ToIntegerRange,
    MirF64ToIntegerRounding, MirFieldDeclaration, MirFunctionDeclaration,
    ...
    MirIntegerDivisorCheck, MirIntegerType, MirInterfaceCallTarget, MirInterfaceConformance,
    MirInterfaceDeclaration, MirInterfaceDeclarationTable, MirInterfaceRequirement, MirIoBuffer,
    MirIoInstruction, MirIoOperation, MirLiteralData, MirLiteralDataTable, MirLogicalExpression,
    MirLogicalOperation, MirMemberDefinition, MirMemberDefinitionTable, MirMethodCallTarget,
    MirMethodDeclaration, MirMethodKind, MirMethodReceiver, MirObjectOrigin, MirObjectView,
    MirOptionalAssign, MirOptionalAssignmentPlan, MirOptionalBoundaryPlan,
    MirOptionalBoundaryPlans, MirOptionalBoxCompletion, MirOptionalBoxType,
    MirOptionalBoxTypeTable, MirOptionalCheckedAccess, MirOptionalCleanupPlan, MirOptionalCopyPlan,
    ...
    MirPlace, MirPlaceBase, MirPlaceProjection, MirPresenceTestKind, MirPrimitiveCast,
    MirPrimitiveCastKind, MirPrimitiveCastRangeCheck, MirPrimitiveComparison, MirPrimitiveType,
    MirProgram, MirProgramLifecycle, MirReceiverAccess, MirRequirementImplementation,
    MirRightShiftFlavor, MirRvalue, MirRvalueKind, MirSelectedCopyOperation, MirSharedAdopt,
    MirSharedAllocate, MirSharedAllocationMode, MirSharedAllocationOrigin,
    ...
    MirSharedTarget, MirShiftCountCheck, MirShiftDirection, MirShiftOperation,

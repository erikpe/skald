...
pub use model::{
    ...
    MirMethodReceiver, MirObjectOrigin, MirObjectView, MirOptionalAssign, MirOptionalInitialize,
    ...
    MirStaticActivationRegion, MirStaticActivationWork, MirStaticAllocationOrigin,
    MirStaticDataMutability, MirStaticDestructionRegion, MirStaticFieldInitialization,
    MirStaticInitializerBody, MirStaticLifecycleCertificate, MirStaticLifecycleCoordinator,
    ...
    PlannedMirProgram, PreliminaryMirProgram, PreliminaryMirSharedLifecycleTarget,

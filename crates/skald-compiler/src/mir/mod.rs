...
pub use model::{
    ...
    MirIntegerDivisionKind, MirIntegerDivisionOperation, MirIntegerType, MirInterfaceCallTarget,
    ...
    MirPresenceTestKind, MirPrimitiveComparison, MirPrimitiveType, MirProgram, MirReceiverAccess,

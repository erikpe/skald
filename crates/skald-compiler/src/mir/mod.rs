...
pub use model::{
    ...
    MirObjectOrigin, MirObjectView, MirOptionalAssign, MirOptionalInitialize, MirOptionalSource,
    MirOptionalViewBegin, MirOptionalViewEnd, MirParameter, MirParameterMode, MirPlace,
    MirPlaceBase, MirPlaceProjection, MirPresenceTestKind, MirPrimitiveType, MirProgram,
    ...
    MirStorage, MirStorageKind, MirStore, MirSynthesizedCopy, MirSynthesizedFieldCopy,
    MirTerminationReason, MirTerminator, MirType, MirUnaryOperation, MirUserCopy, MirValue,
    MirViewTarget, MirVirtualFamily, MirVirtualFamilyTable, OptionalGuardId, StorageId, ValueId,
};

...
pub use model::{
    ...
    MirShiftDirection, MirShiftOperation, MirStaticAllocationOrigin, MirStaticDataMutability,
    MirStorage, MirStorageDead, MirStorageKind, MirStorageLive, MirStore, MirStringInitialize,

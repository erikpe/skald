...
fn lowers_runtime_type_operations_to_explicit_metadata_and_control_flow() {
    ...
    assert!(dump.contains("terminate object-cast-failure"));
...
#[test]
fn folds_static_type_tests_and_casts_without_metadata_queries() {
...
#[test]
fn rejects_invalid_type_targets_and_results() {

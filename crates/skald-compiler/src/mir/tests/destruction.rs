...
fn cleanup_dump_is_exact_and_target_independent() {
    ...
    assert_eq!(
        ...
        concat!(
            ...
            "  Entry f0\n",
            "  Classes\n",
            "    Class c0 module m0 \"Leaf\" @0..24\n",
            "      Initializer c0:init0() @13..22\n",
            "      CopyConstructor\n",
            "        Synthesized c0\n",
            "      CopyAssignment\n",
            "        Synthesized c0\n",
            "    Class c1 module m0 \"Owner\" @25..83\n",
            ...
            "        Field c1:field0\n",
            "  Declarations\n",
            "    Declaration f0 module m0 \"main\" internal @84..142\n",
            "      Signature () -> i64\n",
            "  Definitions\n",

...
pub enum MirInstruction {
    ...
    NestedOptionalInitialize(super::optional::MirNestedOptionalInitialize),
    NestedOptionalAssign(super::optional::MirNestedOptionalAssign),
    NestedOptionalPublish(super::optional::MirNestedOptionalPublish),
    NestedOptionalCleanup(super::optional::MirNestedOptionalCleanup),
...
impl MirInstruction {
    pub const fn span(&self) -> Span {
        match self {
            ...
            Self::NestedOptionalInitialize(instruction) => instruction.span,
            Self::NestedOptionalAssign(instruction) => instruction.span,
            Self::NestedOptionalPublish(instruction) => instruction.span,
            Self::NestedOptionalCleanup(instruction) => instruction.span,

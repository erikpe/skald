...
arrays, explicit optional values, integer division and remainder, integer
bitwise operations and checked shifts, exact boolean operators, same-type
integer comparisons, total integer casts, and raw-byte strings execute through
verified MIR on x86-64. Strings

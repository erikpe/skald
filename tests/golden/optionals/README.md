...
transfer, and guarded clear and replacement. Lifecycle output remains exact;
native failures use stable panic prefixes so future stack traces do not
invalidate the owned observation.

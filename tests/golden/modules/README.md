...
provider roots, self-import rejection, import cycles and bindings, visibility,
malformed providers, and provider collisions. Provider trees remain below `cases/` and are loaded

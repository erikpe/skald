...
branch scope, parser failures, break, continue, lifecycle cleanup, and typed
conditions. Lifecycle and nested-control sources remain focused so exact
effect traces are not hidden behind selector programs.

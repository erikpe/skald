...
optionals, arrays, nested generic vectors, shared exact/interface owners,
optional shared owners, shared optional boxes, optional box owners, prompt
last-owner release, and cross-module applications. The positive generic
type-shape matrix keeps every specialization in its own function within one
compilation unit and forces each vector through geometric growth.

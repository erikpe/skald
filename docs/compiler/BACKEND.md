...
The primitive, exact-class, and inline-optional slices of the frozen explicit
array element-list extension add no new target semantic choice. Instruction selection receives
...
the whole wrapper is live. All three reuse checked allocation, inline/shared header layout,
...
Nested-array, shared-owner, and optional-owner element operations remain
staged for later roadmap entries.

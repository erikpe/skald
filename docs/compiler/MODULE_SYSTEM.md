...
the complete bundle exactly once and publishes its exact template and
requirement identities. Primitive-only operations neither load nor validate
it, including under `--no-stdlib`.

...
- [Strings](STRINGS.md) defines the implemented raw-byte `std::str::Str`
  ...
  operations including canonical boolean and integer formatting and exact
  optional parsing, the compiler/library boundary, and the remaining frozen
  binary64 conversion contract.

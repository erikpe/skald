...
| [Static fields](STATIC_FIELDS.md) | **Zero-default execution complete; explicit initializer HIR complete** | Dedicated declarations have independent dense identity, ordinary-member collision and inheritance rules, declaring-class privacy, and separate zero-default versus explicit stored-value validation. Class- and module-qualified primitive, inline-optional, `shared? T`, and inline-array operations lower through receiver-free identity-based HIR and verified always-live MIR roots to deterministic private x86-64 zero slots. Explicit expressions resolve and type-check once under stable field-derived identities through ordinary construction, copy, owner-transfer, optional, string, and array semantics. Their complete stored-value plans are retained in HIR; `DRV001` currently stops compilation before lifecycle MIR and execution. |

...
| [Primitive integer casts](TYPES_AND_VALUES.md#explicit-integer-casts) | **Frozen design** | All nine explicit total two's-complement/modulo casts among `i64`, `u64`, and `u8` are settled, but primitive-keyword cast targets remain unaccepted. |

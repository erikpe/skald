...
| [`break` and `continue`](FUNCTIONS_AND_CONTROL_FLOW.md#while-loops-and-loop-exits) | **Frozen design** | Both words are reserved and receive focused unsupported diagnostics. Their value-free nearest-loop targeting and deterministic exited-scope cleanup are frozen for later implementation. |

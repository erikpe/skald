...
| [Static inheritance semantics](POLYMORPHISM.md#hierarchies-and-declaration-namespaces) | **Frontend/MIR contract** | Canonical single-base identity; mandatory `super(...)`; complete lifecycle composition; inherited fields and direct methods through verified base projections; access-preserving class/`Obj` views; and exact-copy owning slices. Target layout and execution remain unavailable. |
...
|---|---|---|
| [Inheritance and polymorphism](POLYMORPHISM.md) | **Frozen design** | Static hierarchy, lifecycle, inherited access, ancestor/`Obj` views, and slicing reach verified MIR. Base layout and execution, virtual and interface dispatch, type tests, and narrowing remain unavailable. |

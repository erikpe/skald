...
|---|---|---|
| [Dynamic polymorphism](POLYMORPHISM.md) | **Frozen design** | Static hierarchy, lifecycle, inherited access, ancestor/`Obj` views, slicing, and x86-64 execution are implemented. Virtual and interface dispatch, type tests, and narrowing remain unavailable. |

...
|---|---|---|
| [Complete explicit primitive cast matrix](TYPES_AND_VALUES.md#frozen-complete-explicit-primitive-cast-matrix) | **Frozen design** | All twenty-five explicit casts among `i64`, `u64`, `u8`, `f64`, and `bool` have settled value, rounding, truncation, failure, evaluation-order, IR, target, and unchanged-runtime-ABI contracts. Only the nine integer cells are currently implemented; writing the implementation roadmap is the next planning step. |

...
| [Primitive types and literals](TYPES_AND_VALUES.md#literal-types-and-ranges) | **Implemented contract** | `i64`, `u64`, `u8`, `f64`, and `bool`; payload-free `unit` results; decimal and hexadecimal integer magnitudes, spelling-selected numeric types, and checked literal ranges. |

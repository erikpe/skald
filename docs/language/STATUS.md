...
| [`continue`](FUNCTIONS_AND_CONTROL_FLOW.md#while-loops-and-loop-exits) | **Frozen design** | Reserved and diagnosed as unsupported. Its nearest-loop targeting and deterministic cleanup before the next condition test are frozen for later implementation. |

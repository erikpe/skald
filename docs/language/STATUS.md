...
| [Zero-default static fields](STATIC_FIELDS.md) | **Primitive and inline-optional execution implemented** | Dedicated declarations have independent dense identity, ordinary-member collision and inheritance rules, declaring-class privacy, and centralized zero-default validation. Class- and module-qualified primitive and inline-optional operations, checked payload views, replacement, and aliases lower through receiver-free identity-based HIR and verified always-live MIR roots to deterministic private x86-64 zero slots. Optional shared-owner and inline-array uses remain staged behind `TYP043`. |

...
| [Shared object-cast extension](OBJECT_CASTS.md) | **Frozen design** | `(shared T) source` and future copy allocation through `new T((T) source)` remain planned. Plain casts and their implemented owning consumers never allocate. |

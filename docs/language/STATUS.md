...
| Broader standard library | **Open question** | The canonical string module and initial whole-stream I/O surface are implemented. Collections, formatting, parsing, and broader library organization remain open. |

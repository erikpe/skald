...
Independent physical verification is implemented; final native program publication remains pending
...
next step is typed program closure and fragment storage after
[independent native physical verification](../compiler/PHYSICAL_REALIZATION.md), in the

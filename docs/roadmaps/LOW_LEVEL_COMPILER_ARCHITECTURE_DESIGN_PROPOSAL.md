...
| LA02 | **[LIR model, construction, and verification](LOW_LEVEL_IR_MODEL_DESIGN_PROPOSAL.md):** identities, values, memory, CFG/edges, effects, call representation, mutation rules, and dumps | Accepted/frozen design; [roadmap in progress](LOW_LEVEL_IR_MODEL_ROADMAP.md), LI01–LI07 complete, LI08 next. Complete lowered execution vocabulary and full callable verification/publication and complete-program closure delivered; selected draft/resource contracts delivered; selected verification/publication pending. Required handoff: supported construction/transformation APIs and exact selected-stage requirements | LA01 and common declaration readiness complete; selected verification/publication pending; concrete native counterparts remain LA03 |

...
Status: accepted architectural direction, updated 2026-09-20. LA01–LA04 and
the blocking D01/D02 placement scalability correction are complete. The
[archived design](../archive/PLACEMENT_CHECKING_SCALABILITY_DESIGN_PROPOSAL.md),
[completed roadmap](../archive/PLACEMENT_CHECKING_SCALABILITY_ROADMAP.md), and
[retained measurements](../development/PLACEMENT_CHECKING_PERFORMANCE.md)
clear LA05 to implement the accepted, frozen
[architecture consolidation and adoption design](../archive/LOW_LEVEL_COMPILER_ADOPTION_DESIGN_PROPOSAL.md)
through its active
[roadmap](LOW_LEVEL_COMPILER_ADOPTION_ROADMAP.md).
The first child
...
[LIR model, construction and verification design](../archive/LOW_LEVEL_IR_MODEL_DESIGN_PROPOSAL.md).
...
selection, deterministic baseline placement, independent placement checking,
checked frame planning, typed physical realization, independent verification,
program closure and private whole-program orchestration are implemented under the
...
The accepted, frozen and implemented
[complete lowering migration design](../archive/COMPLETE_LOW_LEVEL_LOWERING_MIGRATION_DESIGN_PROPOSAL.md)
and [archived implementation roadmap](../archive/COMPLETE_LOW_LEVEL_LOWERING_MIGRATION_ROADMAP.md)
deliver complete private native parity without per-operation fallback.
...
| LA05 | **[Architecture consolidation and adoption](../archive/LOW_LEVEL_COMPILER_ADOPTION_DESIGN_PROPOSAL.md) (accepted, frozen and planned):** production default, phase observations, living contracts, fallback removal, and cumulative review | Active [roadmap](LOW_LEVEL_COMPILER_ADOPTION_ROADMAP.md); independently complete foundation with old direct lowering retired and one maintained LIR pipeline using verified baseline placement | LA04 and D01/D02 placement-cost closure complete; AD01 is next |
...
delivery decisions. Phase preparation and the private native pipeline have qualified
the current boundaries; noisy cost gates remain inconclusive. The accepted,
frozen [LA04 design](../archive/COMPLETE_LOW_LEVEL_LOWERING_MIGRATION_DESIGN_PROPOSAL.md)
and [implementation roadmap](../archive/COMPLETE_LOW_LEVEL_LOWERING_MIGRATION_ROADMAP.md)
deliver complete private parity and transfer production adoption to LA05, using the

...
[implementation](INTEGER_CAST_CHAIN_CANONICALIZATION_ROADMAP.md): arbitrary-
length same-block chains over `u8`, `i64`, and `u64` have a complete finite
algebra and canonical recipes of at most two casts. The algebra and immutable
same-block analysis now exist and drive the live redundancy census; production
rewriting and activation remain later roadmap stages. This is an architectural
completeness decision and does not supply new performance evidence for broader
primitive chains or FMV-03.

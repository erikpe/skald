...
| --- | --- | --- | --- | --- |
| [Low-level IR model, construction and verification](LOW_LEVEL_IR_MODEL_ROADMAP.md) | In progress; LI01 complete | Deliver checked lowered/selected models, builders, verification/publication, edits and immutable inspection | LI02 — Lowered scalar/object model and draft construction | Frozen LA02 model and archived phase design; common declaration readiness passed; selected checks and later LA03 concrete target agreements remain pending |

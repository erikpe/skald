...
| --- | --- | --- | --- | --- |
| [Copy-capability materialization](COPY_CAPABILITY_MATERIALIZATION_ROADMAP.md) | Active | Replace duplicate type-check lifecycle availability and provisional HIR reconstruction with one neutral authority and one-pass HIR plans, subject to explicit evidence gates | CP03 — materialize concrete HIR plans once and decide Gate 2 | [Accepted design](COPY_CAPABILITY_MATERIALIZATION_DESIGN_PROPOSAL.md); [CP01/CP02 measurements](../development/COPY_CAPABILITY_MATERIALIZATION_MEASUREMENTS.md); A08 neutral lifecycle capability ownership |
...
| [Copy-capability materialization design](COPY_CAPABILITY_MATERIALIZATION_DESIGN_PROPOSAL.md) | Frozen accepted design | Define the neutral availability authority, type-check-owned HIR materialization, measurement, and stop conditions | Implement through the active roadmap; CP03 is next after the accepted Gate 1 decision and CP02 transition | [Implementation roadmap](COPY_CAPABILITY_MATERIALIZATION_ROADMAP.md); A08 neutral lifecycle capability ownership; A17 in the cleanup audit |

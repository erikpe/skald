...
| --- | --- | --- | --- | --- |
| [Low-level IR model, construction and verification](LOW_LEVEL_IR_MODEL_ROADMAP.md) | In progress; LI01–LI06 complete | Deliver checked lowered/selected models, builders, verification/publication, edits and immutable inspection | LI07 — Selected payload and resource description contracts | Frozen LA02 model and archived phase design; common declaration readiness passed; selected checks and later LA03 concrete target agreements remain pending |

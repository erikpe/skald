...
| --- | --- | --- | --- | --- |
| [Complete low-level lowering migration](COMPLETE_LOW_LEVEL_LOWERING_MIGRATION_ROADMAP.md) | Active; LM01–LM18 complete | Expand the checked private native pilot to the complete supported language, helper, data and artifact surface | Perform cumulative review, cleanup and LA05 handoff | Accepted frozen LA04 design; complete private parity and maintained coverage/measurement records |

## Pending discovery and planning records

| Record | Status | Purpose | Next step | Dependencies |
| --- | --- | --- | --- | --- |
| [Low-level compiler architecture](LOW_LEVEL_COMPILER_ARCHITECTURE_DESIGN_PROPOSAL.md) | Accepted direction; LA04 closing review remains | Establish explicit LIR phases and shared/target backend ownership, then implement register allocation as a separate final workstream | Close the complete lowering roadmap, then design LA05 adoption | Full private parity and maintained coverage; adoption and allocation remain separate |

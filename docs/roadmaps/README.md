...
address-taken metadata, and trivial stored/callable HIR are implemented behind
a driver pre-MIR gate. FVI4 is next and will type indirect calls through the
complete internal signature.

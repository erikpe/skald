...
| --- | --- | --- | --- | --- |
| [Low-level IR model, construction and verification](LOW_LEVEL_IR_MODEL_ROADMAP.md) | Planned; no implementation started | Deliver checked lowered/selected models, builders, verification/publication, edits and immutable inspection | LI01 — Checked contexts, declarations and identity domains | Frozen LA02 model and archived phase design; preparation handoff; common contract readiness and later LA03 concrete target agreements |

...
| --- | --- | --- | --- | --- |
| [Copy-capability materialization](COPY_CAPABILITY_MATERIALIZATION_ROADMAP.md) | Active; Gate 2 no-go | Evaluate replacing duplicate type-check lifecycle availability and provisional HIR reconstruction with one neutral authority and one-pass HIR plans | CP04 — revert the migration and retain durable evidence | [Accepted design](COPY_CAPABILITY_MATERIALIZATION_DESIGN_PROPOSAL.md); [CP01–CP03 measurements](../development/COPY_CAPABILITY_MATERIALIZATION_MEASUREMENTS.md); A08 neutral lifecycle capability ownership |

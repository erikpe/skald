...
| [Optimization architecture discoveries](OPTIMIZATION_ARCHITECTURE_DISCOVERIES.md) | Three constraints remain; phase preparation, executable LIR model and private native pilot complete | Record architectural limits on modular target-independent and target-specific optimization and their sequencing | Design complete lowering migration; retain separate foundation adoption evidence | Existing pipeline, reachability, normalization, MIR identity and checked native-pilot foundations |

...
| --- | --- | --- | --- | --- |
| [Copy-capability materialization](COPY_CAPABILITY_MATERIALIZATION_ROADMAP.md) | Planned | Replace duplicate type-check lifecycle availability and provisional HIR reconstruction with one neutral authority and one-pass HIR plans, subject to explicit evidence gates | CP01 — measure reconstruction and freeze capability behavior | [Accepted design](COPY_CAPABILITY_MATERIALIZATION_DESIGN_PROPOSAL.md); A08 neutral lifecycle capability ownership |

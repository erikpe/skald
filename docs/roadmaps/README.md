...
| --- | --- | --- | --- | --- |
| [Target selection, checked placement and physical realization](TARGET_SELECTION_PHYSICAL_REALIZATION_ROADMAP.md) | In progress; hardened private whole-program pilot and next-architecture handoff complete | Review the cumulative architecture change, remove residual artifacts and archive the child roadmap | NP19 — Cumulative review, cleanup and closure | Frozen target design, accepted model amendment and completed-model handoff; full migration, adoption and allocation remain separate |

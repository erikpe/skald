...
| --- | --- | --- | --- | --- |
| [Placement checking scalability](PLACEMENT_CHECKING_SCALABILITY_ROADMAP.md) | Planned | Preserve independent placement authority while restoring practical compiler-test time for recursive optionals and live arrays | PS01 measurement and diagnosis | Accepted scalability design, complete private parity and retained D01/D02 witnesses; complete before LA05 |

## Pending discovery and planning records

| Record | Status | Purpose | Next step | Dependencies |
| --- | --- | --- | --- | --- |
| [Placement checking scalability design](PLACEMENT_CHECKING_SCALABILITY_DESIGN_PROPOSAL.md) | Accepted, frozen and promoted | Preserve independent placement authority while replacing excessive full-CFG convergence work and keeping all native witnesses in the ordinary suite | Implement the linked roadmap, beginning with PS01 diagnosis | Complete private parity, accepted placement semantics and the six measured optional/array witnesses |
...
| [Complete lowering migration discoveries](COMPLETE_LOW_LEVEL_LOWERING_MIGRATION_DISCOVERIES.md) | Two blocking inputs promoted into an active implementation roadmap | Track recursive optional/array CFG cost without weakening lifecycle semantics | Use both findings as separate acceptance witnesses through PS06 | Complete private lifecycle pipeline and allocation-independent baseline placement |
...
| [Optimization architecture discoveries](OPTIMIZATION_ARCHITECTURE_DISCOVERIES.md) | Three constraints remain; complete private LIR pipeline delivered | Record architectural limits on modular target-independent and target-specific optimization and their sequencing | Design LA05 adoption with separate foundation cost evidence | Existing pipeline, reachability, normalization, MIR identity and checked native foundations |

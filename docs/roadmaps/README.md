...
| --- | --- | --- | --- | --- |
| [Low-level IR model, construction and verification](LOW_LEVEL_IR_MODEL_ROADMAP.md) | In progress; LI01–LI04 complete | Deliver checked lowered/selected models, builders, verification/publication, edits and immutable inspection | LI05 — Scalar domains, memory checks and lowered publication | Frozen LA02 model and archived phase design; common declaration readiness passed; selected checks and later LA03 concrete target agreements remain pending |

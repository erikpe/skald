...
- [Generic classes](GENERIC_CLASSES_ROADMAP.md) — **In progress; G6 is next.**
  ...
  declarations are implemented; specialization of executable member bodies
  and their operation selections is the next boundary.

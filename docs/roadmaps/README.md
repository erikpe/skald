...
| --- | --- | --- | --- | --- |
| [Copy-capability materialization](COPY_CAPABILITY_MATERIALIZATION_ROADMAP.md) | Active | Replace duplicate type-check lifecycle availability and provisional HIR reconstruction with one neutral authority and one-pass HIR plans, subject to explicit evidence gates | CP02 — establish the request-local neutral authority | [Accepted design](COPY_CAPABILITY_MATERIALIZATION_DESIGN_PROPOSAL.md); [CP01 measurements](../development/COPY_CAPABILITY_MATERIALIZATION_MEASUREMENTS.md); A08 neutral lifecycle capability ownership |

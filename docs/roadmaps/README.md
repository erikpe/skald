...
| --- | --- | --- | --- | --- |
| [Low-level phase architecture and backend ownership](LOW_LEVEL_PHASE_ARCHITECTURE_ROADMAP.md) | In progress; LP01 complete | Establish migration coverage, existing-boundary regressions, and qualified pre-migration measurements | LP02 — Existing backend boundary and behavioral witnesses | Frozen phase architecture design; detailed LIR and target implementation remain later workstreams |

...
private whole-program pilot. The proposed
[complete lowering migration design](COMPLETE_LOW_LEVEL_LOWERING_MIGRATION_DESIGN_PROPOSAL.md)
defines whole-program, no-fallback expansion across the remaining language,
lifecycle, helper, data and artifact surface. Production migration, adoption and

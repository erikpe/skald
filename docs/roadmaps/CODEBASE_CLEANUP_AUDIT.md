...
| [A22](#a22--introduce-virtual-register-target-ir-when-justified) | Introduce virtual-register target IR when justified | Draft overarching and phase designs | P3 | 5 | XL | High | C | N, E |
...
now defines layout-specialized shared lowering, phase products, machine value
flow, and foundation validation for review. Scalar promotion and semantic SSA
remain follow-ups. No implementation is complete or scheduled yet; review the
focused design before creating its implementation roadmap.

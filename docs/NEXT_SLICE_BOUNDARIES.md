...
T0 through T5 are complete: the contracts are fixed, runtime ABI version 4 can
...
System V layout, and SSE2 lowering are also available for compiler-created
MIR. T6's source-level `f64` path is next.
